...
def uploader():
    if request.method == "POST":
        ...
        if "cap" in mysteryfile.filename:
            ...
            return "That format is not yet supported, please chak again sometime later."
...
def emailsender():
    msg = EmailMessage()
    msg['Subject'] = "This is HEMA subject line"
    msg['From'] = "pythonstudent01@mail.com"
    msg['To'] = "rzfeeserspam@gmail.com"
    msg.preamable = "Hey you got a message from Hema"
